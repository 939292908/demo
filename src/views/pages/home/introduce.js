        ...
        return m('div', { class: 'views-pages-home-introduce ' }, [
            ...
            m('div', { class: `introduce-transaction container` }, [
                ...
                m('div', { class: `has-text-centered mt-8` }, [
                    m('a', { class: `button mr-2 has-bg-primary button-register title-medium font-weight-regular`, href: "http://localhost:8080/#!/register", target: "_blank" }, ['立即注册']),
                    m('a', { class: `button has-bg-primary button-transaction title-medium font-weight-regular`, onclick: this.toPage, href: "http://localhost:8080/#!/register", target: "_blank" }, ['即可交易'])
                ]),
                // 橘色 盒子
