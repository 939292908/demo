...
const assetOverview = require('./assetOverview');// 资产总览
const myWallet = require('./myWallet');// 我的钱包
const contract = require('./contract');// 合约账户
const coins = require('./coins');// 币币账户
const legal = require('./legal');// 法币账户
