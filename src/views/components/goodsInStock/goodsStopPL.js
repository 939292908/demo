...
let obj = {
    ...
    getInputStopPL:function(e){
        ...
        this.form.stopPL = utils.getFullNum(utils.getPrzDecimal(stop,maxPrz,minPrz,numb))
    },
            ...
            m("div",{class:"pub-bibi-price"},[
                ...
                m('div',{class:"pub-bibi-price-inp" + (pageTradeStatus == 1?" pub-bibi-price-inp1" : " pub-bibi-price-inp2")},[
                    m("div",{class:"pub-bibi-price-US"},[
                        ...
                        m("input",{class:"input pub-bibi-price-US-input",step: obj.PrzStep,pattern:"\d*",value:obj.form.Prz,type:"number",placeholder: gDI18n.$t('10186'/*"价格"*/),oninput:function(e){
                            obj.getInputPrz(e)
                        }}),
                    ]),
