...
let footer = require('./footer').default
let header = require('./header').default
let layout = require('./layout').default
let layout_m = require('./layout_m').default
let message = require('./message').default
...
let main = {
    ...
    setDisplayTrdInfo: function () {
        ...
        if (info.pos && info.ord && info.wlt && info.rs) {
            ...
            let cb = function (arg) {
                gEVBUS.emit(window.gTrd.EV_POSABDWLTCALCOVER_UPD, {
                    Ev: window.gTrd.EV_POSABDWLTCALCOVER_UPD,
                    data: arg
                })
            }
...
module.exports = {
    ...
    oncreate: function (vnode) {
        ...
        body.addEventListener('click', function () {
            gEVBUS.emit(gEVBUS.EV_ClICKBODY, {
                ev: gEVBUS.EV_ClICKBODY
            })
        }, false)
        main.delNullPosPlan()
