        ...
        return m("div", { class: "modal" + (vnode.attrs.isShow ? " is-active" : '') }, [
            ...
            m("div", { class: "modal-card" }, [
                ...
                m("header", { class: "pub-set-lever-head modal-card-head" }, [
                    // 标题
                    m("p", { class: "modal-card-title" }, vnode.attrs.slot.header ? vnode.attrs.slot.header : ['头部标题']),
                    // 关闭按钮
                    m("button", { class: "delete", "aria-label": "close", onclick: vnode.attrs.onClose }),
                ]),
                // 内容
                m("section", { class: "modal-card-body" }, vnode.attrs.slot.body ? vnode.attrs.slot.body : ['内容部分']),
                // 底部
                m("footer", { class: "modal-card-foot" }, vnode.attrs.slot.footer ? vnode.attrs.slot.footer : vnode.attrs.onOk ? [
