...
module.exports = {
    ...
    view (vnode) {
        return m('div', { class: `my-tooltip dropdown is-hoverable ${vnode.attrs.class ? vnode.attrs.class : ''}` }, [
            ...
            m('div', {
                class: vnode.state.getMenuClass(vnode)
                // class: `dropdown-menu has-text-white ${vnode.attrs.hiddenArrows ? '' : 'arrows'} my-tooltip-${vnode.attrs.direction ? vnode.attrs.direction : 'center'} ${vnode.attrs.content ? '' : 'is-hidden'}`
            }, [
