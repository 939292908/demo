...
let obj = {
    ...
    getProFitType:function(){
        this.params.profitType == 1 ? this.params.profitType = 2 : this.params.profitType = 1
        this.initFuture()
    },
    //收益
    getprofit:function(e){
        let val = e.target.value
        if(val < 0){
            this.params.profit = null
        }else {
            this.params.profit = val
        }
        this.initFuture()
    },
}
    ...
    view: function (vnode) {
        return m('div',{class:"calculator is-flex is-text-3 has-text-2"},[
            ...
            m('div',{class:"calculator-public-left pr-3"},[
                ...
                m('div',{class:"is-flex input-border-lable mb-3 px-3"},[
                    m('div',{class:"input-left"},[
                        obj.params.profitType == 1 ?"收益" : "收益率%",
                        m('span',{class:"pl-2"},[
                    ...
                    m('input',{class:"input input-border-line",type: 'number',value : obj.params.profit,oninput:function(e){
                        obj.getprofit(e)
                    }}),
                    m('div',{class:"input-right"},[
                        obj.params.profitType == 1 ?obj.AssetD.QuoteCoin || '' : "%"
                    ])
                ]),
            ]),
            //右边显示区域
