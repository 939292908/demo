    ...
    submit: function(dir){
        ...
        if(PId){
            ...
            if(planList.length >= 5){
                return $message({ title: gDI18n.$t('10037'/*"提示"*/), content: gDI18n.$t('10161'/*'同一仓位ID计划单最多5条！'*/), type: 'danger'})
            }
        }else{
            let planList = Orders.filter(function(item){
            ...
            if(planList.length >= 10){
                return $message({ title: gDI18n.$t('10037'/*"提示"*/), content: gDI18n.$t('10162'/*'同一合约计划单最多10条！'*/), type: 'danger'})
            }
        }
        ...
        let tradType = window.gWebAPI.CTX.UserSetting.trade[3]
