        ...
        return m('div', { class: 'views-pages-home-introduce ' }, [
            ...
            m('div', { class: ``, style: `background: url(${require("@/assets/img/home/layer_14.png").default}) no-repeat center center / 100% 100%;` }, [
                ...
                m('div', { class: `container ` }, [
                    m('div', { class: `pt-8 title-x-large` }, [
                        m('p', { class: `font-weight-regular ${utils.isMobile() ? 'ml-7 title-small ' : ''}` }, "世界领先的专业数字资产衍生品交易平台"),
            ...
            m('div', { class: `introduce-transaction container` }, [
                ...
                m('div', { class: `has-text-centered mt-8` }, [
                    m('a', { class: `border-radius-medium button-register has-bg-primary button mr-2 title-medium font-weight-regular skew-right ${utils.isMobile() ? 'body-5 ' : 'pc才有的类名xx'}`, href: "/#!/register", target: "_blank" }, ['立即注册']),
                ...
                m('div', { class: `home-introduce-Rectangle border-1 container is-align-items-center has-bg-primary ` }, [
                    ...
                    m('div', { class: `pr-6 mb-8` }, [
                        m('p', { class: `ml-7 title-large font-weight-regular` }, ['随时随地交易']),
                        m('p', { class: `pt-2 ${utils.isMobile() ? 'title-small  ml-7 font-weight-regular' : 'ml-7'}` }, ['下载Vbit移动应用端'])
                    ]),
                    // 下载按钮
