/*
 * @Author: your name
 * @Date: 2020-09-27 11:10:06
 * @LastEditTime: 2020-09-27 11:14:19
    ...
    view: function () {
        return m('div.safety-man theme--light', [
            m('div.liftingBox content-width dis-flex justify-between align-stretch', [
                m('div.leftBox', [
                    m('div', m(Block, { Icon: m('i.iconfont icon-GoogleVerification'), title: l180n.$t('10227') /* '谷歌验证' */, subhead: l180n.$t('10243') /* '用于提现和修改安全设置' */ }, m('div.dis-flex', [
                        mainLogic.user?.googleId ? m('div.but has-bg-primary py-1 px-4', { onclick: this.handleToUrl.bind(this, '/bindGoogle?type=unbind') }, l180n.$t('10245') /* '解绑' */) : m('div.but has-bg-primary py-1 px-4', { onclick: this.handleToUrl.bind(this, '/bindGoogle?type=bind') }, l180n.$t('10231') /* '绑定' */)
                    ]))),
                ...
                m('div.rightBox', [
                    ...
                    m('div', { class: 'mb-5' }, m(Block, { Icon: m('i.iconfont icon-AntiFishing'), title: l180n.$t('10232') /* '防钓鱼码' */, subhead: l180n.$t('10247', { value: Conf.exchName }) /* 'XXXX给您发送邮件内容将包含您设置的防钓鱼码' */ }, m('div.dis-flex', [
                        m('div.but has-bg-primary py-1 px-4',
                            ...
                            mainLogic.user?.antiFishCode ? l180n.$t('10239') /* '修改' */ : l180n.$t('10233')/* '设置' */)
                    ])))
                ])
            ]),
            m('div', { class: 'mb-5' }, m(Block, { Icon: m('i.iconfont icon-FundPassword'), title: l180n.$t('10512') /* '登录密码' */, subhead: l180n.$t('10241') /* '通过设置登录密码，您将可以使用账号和登录密码直接登录' */ }, m('div.dis-flex', [
                m('div', { class: 'but has-bg-primary py-1 px-4', onclick: this.handleToUrl.bind(this, '/modifyLoginPassword') }, l180n.$t('10239') /* '修改' */)
            ])))
