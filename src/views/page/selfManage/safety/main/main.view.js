            ...
            m('div.liftingBox content-width dis-flex justify-between align-stretch', [
                m('div.leftBox', [
                    m('div', m(Block, { Icon: m('i.iconfont icon-GoogleVerification'), title: l180n.$t('10227') /* '谷歌验证' */, subhead: l180n.$t('10243') /* '用于提现和修改安全设置' */ }, m('div.dis-flex', [
                        mainLogic.user?.setting2fa?.google ? m('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '/closeGoogleVerify') }, l180n.$t('10245') /* '解绑' */) : m('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '/openGoogleVerify') }, '开启')
                    ]))),
                    m('div.addPadding py-5', m(Block, { Icon: m('i.iconfont icon-PhoneVerification'), title: l180n.$t('10228') /* '手机验证' */, subhead: l180n.$t('10243') /* '用于提现和修改安全设置' */ }, m('div.dis-flex', [
                        mainLogic.user?.setting2fa?.phone ? m('div.has-text-primary', mainLogic.user?.phone) : ('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '/bindPhone') }, l180n.$t('10249') /* '开启' */)
                    ]))),
                    m('div', m(Block, { Icon: m('i.iconfont icon-Mailbox'), title: l180n.$t('10229') /* '邮箱验证' */, subhead: l180n.$t('10243') /* '用于提现和修改安全设置' */ }, m('div.dis-flex', [
                        mainLogic.user?.setting2fa?.email ? m('div.has-text-primary', mainLogic.user?.email) : m('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '/bindEmail') }, l180n.$t('10249') /* '开启' */)
                    ])))
                ]),
                m('div.rightBox', [
                    m('div.mb-5', m(Block, { Icon: m('i.iconfont icon-Authentication'), title: l180n.$t('10182') /* '身份认证' */, subhead: l180n.$t('10234') /* '完成认证获得更高提币额度' */ }, m('div.dis-flex', [
                        m('div.has-text-primary', { onclick: this.handleToUrl.bind(this, '') }, l180n.$t('10223') /* '未认证' */)
                    ]))),
                    m('div', { class: 'mb-5' }, m(Block, { Icon: m('i.iconfont icon-FundPassword'), title: l180n.$t('10128') /* '资金密码 */, subhead: l180n.$t('10235') /* '用于内部转账和法币交易确认 */ }, m('div.dis-flex', [
                        m('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '') }, l180n.$t('10239') /* '修改' */)
                    ]))),
                    m('div', { class: 'mb-5' }, m(Block, { Icon: m('i.iconfont icon-AntiFishing'), title: l180n.$t('10232') /* '防钓鱼码' */, subhead: l180n.$t('10247') /* 'XXXX给您发送邮件内容将包含您设置的防钓鱼码' */ }, m('div.dis-flex', [
                        m('div.but py-1 px-4', { onclick: this.handleToUrl.bind(this, '') }, l180n.$t('10239') /* '修改' */)
                    ])))
                ])
            ]),
