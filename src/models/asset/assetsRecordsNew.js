...
module.exports = {
    ...
    filterList() {
        ...
        this.showList = this.showList.filter(item => {
            ...
            console.log(this.filterTime[1]);
            console.log(this.filterTime[0] <= item.timestamp && this.filterTime[1] >= item.timestamp);
            return (this.coin === 'all' || this.coin === item.coin) && (!this.filterTime.length || (this.filterTime[0] <= Number(item.timestamp) && this.filterTime[1] >= Number(item.timestamp)));
        });
