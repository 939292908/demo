...
// 红包错误码
methods.getRedPacketErrorCode = function(code, value) {
    const obj = {
        "-1": I18n.$t('20140')/* 系统繁忙，请稍后重试 */, // 未知错误
        "-1000": I18n.$t('20126')/* 哎呀出错啦~快截图找客服！ */, // 无效币种
        "-1001": I18n.$t('20127', { value: value })/* 单个红包最高发送金额{value} */, // 超过最高金额
        "-1002": I18n.$t('20129')/* 红包已失效，下一个打起精神！ */, // 红包不存在或已失效
        "-1003": I18n.$t('20126')/* 哎呀出错啦~快截图找客服！ */, // 参数错误
        "-1004": I18n.$t('20130')/* 已领过此红包，不要贪心哦~ */, // 已领取过此红包
        "-1005": I18n.$t('20131')/* 红包已领完，下一个打起精神！ */, // 红包已领完
        "-1006": I18n.$t('20128', { value: value })/* 单个红包最低发送金额{value} */, // 低于最低金额
        "-1007": I18n.$t('20132')/* 资金密码错误 */, // 资金密码错误
        "-1008": I18n.$t('20133')/* 密码修改，密码重置或2FA解绑后，24H内禁止发送红包 */,
        "-1009": I18n.$t('20139')/* 已超出今日红包发送次数，明日再来哦 */, // 超过单日红包发送次数
        "-1010": I18n.$t('20138', { value: value })/* 已超出单日发送限额{value} */, // 超过单日金额限制
        "-1011": I18n.$t('20088', { value: value })/* 一次最多可发{value}个红包 */ // 超过单次红包最大个数 或 系统账户余额不足
    };
